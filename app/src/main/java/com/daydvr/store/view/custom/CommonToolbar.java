...
/**
 * @author LoSyc
 * @version Created on 2017/12/28. 14:52
 */
...
public class CommonToolbar extends Toolbar {
    ...
    private void resolveAttrs(AttributeSet attrs, int defStyleAttr) {
        ...
        mCenterTitleTextColor = a.getColor(R.styleable.Toolbar_titleTextColor, 0xff000000);
        a.recycle();
    }
            ...
            if (mCenterTextView == null) {
                ...
                if (mCenterTitleTextAppearance != 0) {
                    if(VERSION.SDK_INT< VERSION_CODES.M){
                        ...
                        mCenterTextView.setTextAppearance( mCenterTitleTextAppearance);
                    }
                }
