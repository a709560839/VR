...
public class ParticleView extends View {
        ...
        for (int i = 0; i < ROW_NUM; i++) {
            for (int j = 0; j < COLUMN_NUM; j++) {
                ...
                ValueAnimator animator = ValueAnimator
                        .ofObject(new LineEvaluator(), mParticles[i][j], mMinParticles[i][j]);
    ...
    private void startSpreadAnim() {
        ValueAnimator animator = ValueAnimator
                .ofFloat(0, getTextWidth(mParticleText, mParticleTextPaint) / 2 + dip2px(4));
    ...
    private void startHostTextAnim() {
        ...
        ValueAnimator particleTextXAnim = ValueAnimator
                .ofFloat(mStartMinP.x + dip2px(4), mWidth / 2 - (getTextWidth(mHostText, mHostTextPaint) + getTextWidth(mParticleText, mParticleTextPaint)) / 2 + getTextWidth(mHostText, mHostTextPaint));
        ...
        ValueAnimator hostTextXAnim = ValueAnimator
                .ofFloat(mStartMinP.x, mWidth / 2 - (getTextWidth(mHostText, mHostTextPaint) + getTextWidth(mParticleText, mParticleTextPaint) + dip2px(20)) / 2);
