...
public class RotateProgressBar extends View {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        if (null != attrs) {
            TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.RotateProgressBar);
            color = typedArray.getColor(R.styleable.RotateProgressBar_loading_color, Color.WHITE);
            width = typedArray.getDimensionPixelSize(R.styleable.RotateProgressBar_loading_width, dpToPx(context, DEFAULT_WIDTH));
            shadowPosition = typedArray.getInt(R.styleable.RotateProgressBar_shadow_position, DEFAULT_SHADOW_POSITION);
            speedOfDegree = typedArray.getInt(R.styleable.RotateProgressBar_loading_speed, DEFAULT_SPEED_OF_DEGREE);
            typedArray.recycle();
        }
