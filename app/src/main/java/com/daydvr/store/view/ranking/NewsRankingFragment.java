...
public class NewsRankingFragment extends BaseFragment implements BaseGameRankingContract.View {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        mRootView = inflater.inflate(R.layout.fragment_news_ranking, container, false);
        mPresenter = new NewsRankingPresenter(this);
    ...
    protected void onFragmentVisibleChange(boolean isVisible) {
        ...
        Logger.d("daydvr.NewsRankingFragment", "   isVisible:   " + isVisible);
        if (isVisible) {
    ...
    private void initView() {
        mRecyclerView = mRootView.findViewById(R.id.rv_news_ranking);
    ...
    public void setPresenter(BaseGameRankingContract.Presenter presenter) {
        mPresenter = (NewsRankingPresenter) presenter;
    }
                            ...
                            for (int i = 1; i <= 300 && !Thread.currentThread().isInterrupted(); ) {
                                try {
                                    ...
                                    if (i == 300 && this.getHandler().equals(mHandler)) {
                                        Message msg = this.getHandler().createMessage(NEWS_RANKING_UI_UPDATE, 0, 0, this.getHolder());
